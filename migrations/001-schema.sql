...
DROP TABLE IF EXISTS `music_audiofile`;
CREATE TABLE `music_audiofile` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `s3_mp3_url` varchar(255) DEFAULT NULL,
  `s3_ogg_url` varchar(255) DEFAULT NULL,
  `large_art_url` varchar(255) DEFAULT NULL,
  `medium_art_url` varchar(255) DEFAULT NULL,
  `small_art_url` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `music_audiofile_3904588a` (`email`),
  KEY `music_audiofile_738a9118` (`artist`),
  KEY `music_audiofile_be9cd983` (`album`)
